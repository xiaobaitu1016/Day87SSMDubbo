        ...
        <div class="traffic_guide">
            ...
            <div class="illness_classify border" style="font-size: 12px">
                <div class="illness_list clearfix  H_link">
                    ...
                    <ul class="list_ul list_list clearfix" >
                        ...
                        <li class="con_hidden "><a href="http://www.mingyihui.net/hospital_1302/expert_3.html" target="_self">病理科</a></li>
                ...
                <div class="illness_list clearfix">
                    ...
                    <ul class="list_ul clearfix">
                        <li class="  on"><a href="http://www.mingyihui.net/hospital_1302/expert.html" target="_self">全部</a></li>
                        <li class=" "><a href="http://www.mingyihui.net/hospital_1302/expert_t4.html" target="_self">主任医师</a></li>
            ...
            <div class="inquire_doctor"> <strong class="left">擅长疾病</strong>
                <div class="inquire_input left">
                    ...
                    <input type="text" id="txtDisease" value="" placeholder="输入疾病名称搜索好评医生">
                    <input class="submit" type="button" id="btnSkilled" value="快速查询">
                    ...
                    <ul>
                        <li class="clearfix">
                            <a href="/hospital_1302/expert_GuanXinBing.html" target="_self"><div class="classify_h3 left hscDisease">
                                <p class="color_333">冠心病</p>
                                <span class="color_999">(57人) ：</span></div></a>

                            <div class="classify_name left"> <span class="yellow">NO.1</span> <a class="color_333" href="/doctor_225914.html">陈文生</a> </div>

                            <div class="classify_name left"> <span class="yellow">NO.2</span> <a class="color_333" href="/doctor_225918.html">易定华</a> </div>

                            <div class="classify_name left"> <span class="yellow">NO.3</span> <a class="color_333" href="/doctor_225712.html">李兰荪</a> </div>

                            <div class="classify_name left"> <span class="neworange">NO.4</span> <a class="color_333" href="/doctor_225719.html">马淑坤</a> </div>

                            <div class="classify_name left"> <span class="neworange">NO.5</span> <a class="color_333" href="/doctor_225698.html">王海昌</a> </div>
